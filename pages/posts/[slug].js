    ...
    <Layout>
      ...
      <article className="px-6 md:px-0">
        ...
        <div className="mt-12 text-center">
          <Link
            href="/"
            className="inline-block px-10 py-4 text-white transition bg-primary dark:bg-primary rounded-lg hover:bg-opacity-10 dark:bg-primary-700 dark:hover:bg-opacity-10"
          >
            Back to Home
          </Link>
        </div>
